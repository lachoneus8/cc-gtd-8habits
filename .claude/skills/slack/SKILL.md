...
When applying changes to this repo, place durable reference notes in `reference/`, daily planning notes in `personal-untracked/daily/YYYY-MM-DD.md`, delegated items in `personal-untracked/waiting-for.md`, and project tasks in the relevant `personal-untracked/projects/active/<project>/tasks.md` file.
